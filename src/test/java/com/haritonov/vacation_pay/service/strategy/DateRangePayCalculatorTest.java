...
public class DateRangePayCalculatorTest {
    ...
    void whenNoHolidaysPaysAllDays() {
        ...
        request.setVacationDate(LocalDate.of(2026, 3, 1));
    ...
    void whenOneHoliday() {
        ...
        request.setVacationDate(LocalDate.of(2026, 2, 22));
    ...
    void whenAllHolidaysPaysZero() {
        ...
        request.setVacationDate(LocalDate.of(2026, 1, 1));
        request.setVacationDays(3);
    ...
    void whenWeekendNotHolidaysPays() {
        ...
        setupCalculatorWithHolidays(List.of());
        request.setVacationDate(LocalDate.of(2026, 1, 17));
